...
namespace Lykke.Service.CexIoAdapter
{
    public class Startup
    {
        ...
        private static ILog CreateLogWithSlack(IServiceCollection services, IReloadingManager<AppSettings> settings)
        {
            ...
            var dbLogConnectionStringManager = settings.Nested(x => x.CexIoAdapterService.Db.LogsConnString);
            ...
            var persistenceManager = new LykkeLogToAzureStoragePersistenceManager(
                AzureTableStorage<LogEntity>.Create(dbLogConnectionStringManager, "CexIoAdapterLog", consoleLogger),
                consoleLogger);
