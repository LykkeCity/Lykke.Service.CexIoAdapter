...
autorest --input-file=http://localhost:5000/swagger/v1/swagger.json --csharp --output-folder=./client/Lykke.Service.CexIoAdapter.Client/AutorestClient --namespace=Lykke.Service.CexIoAdapter.Client.AutorestClient